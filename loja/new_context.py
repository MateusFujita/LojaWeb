...
def categoriasTipo(request):
    categoriasBarra = Categoria.objects.all()
    tiposBarra = Tipo.objects.all()
    return {"categoriasBarra": categoriasBarra, "tiposBarra": tiposBarra}